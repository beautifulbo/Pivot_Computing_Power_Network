...
import { mockProductListData } from '@/utils/mockData';
...
const IndexPage: React.FC = () => {
  ...
  const queryPage = async (
    ...
    // 使用模拟数据
    let productList = mockProductListData.data.list as any[];
    ...
    if (params.deviceType) {
      productList = productList.filter((p: any) => 
        p.deviceType === Number(params.deviceType)
      );
    }
    
    return {
      data: productList as PRODUCT_INFO[],
