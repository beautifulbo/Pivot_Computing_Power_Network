  ...
  <div class="login-container">
    <el-row>
      <el-col :span="17"  class="video-col">
        <div :style="vedio-container">
        <div :style="fixStyle" class="filter"></div>
          <video :style="fixStyle" autoplay loop class="fillWidth" v-on:canplay="canplay" ref="myVideo">
...
.login-container {
  ...
  .vedio-container .poster img,
  .vedio-container video {
    z-index: 0;
    position: absolute;
  }

  .vedio-container .filter {
    z-index: 1;
    position: absolute;
