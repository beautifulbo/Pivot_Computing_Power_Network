...
if(predictday===7||predictday===14){
  daysToPlot=predictday
      ...
      const data = [
      {
            x: timeSeries.slice(0, 14 * 24), // 过去14天的时间序列
            y: gtValues.slice(0, 14 * 24), // 过去14天的真实流量
            mode: 'lines',
            name: '真实流量',
            line: { width: 4 }
        },
        {
            x: timeSeries.slice(14 * 24, daysToShow * 24), // 未来7天的时间序列
            y: pdValues.slice(14 * 24, daysToShow * 24), // 未来7天的预测流量
            mode: 'lines',
            name: '预测流量',
