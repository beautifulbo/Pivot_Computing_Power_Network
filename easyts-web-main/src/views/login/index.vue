<template>
  <div class="login-container">
        ...
        <!-- <div :style="fixStyle" class="filter"></div> -->
          <video muted autoplay loop :style="fixStyle" class="fillWidth" v-on:canplay="canplay">
    ...
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on" label-position="left">
      ...
      <div class="title-container">
        <h3 class="title">EdgeBigBang时序预测小组</h3>
      </div>
...
.form-container {
  ...
  .white-overlay {
  position: absolute;
  padding: 350px 190px 0;
  margin: 0 auto;
 
  background-color: white; /* 设置白色背景 */
  opacity: 1; /* 设置透明度，根据需要进行调整 */
