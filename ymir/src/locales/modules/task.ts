const task = {
  ...
  'task.train.form.FL.clientchoose':{en: 'client num per round', cn: '每轮选择的客户端数量'},
  'task.train.form.FL.lim':{en: '<= node num', cn: '不能超过结点总数'},
  'task.train.form.FL.global':{en: 'global round', cn: '全局训练轮数'},
  'task.train.form.FL.bathsize':{en: 'bathsize', cn: 'bathsize'},
  'task.train.form.FL.optimizer':{en: 'optimizer', cn: '优化器'},
  'task.train.form.FL.lr':{en: 'Learning Rate', cn: '学习率'},
