const model = {
  ...
  'model.add.types.internal': { en: 'Internal', cn: '公共模型' },
  'model.add.success': { en: 'Import model success!', cn: '导入模型成功！' },
  'model.add.form.name': { en: 'Name', cn: '名称' },
  'model.add.form.node': { en: 'Select FLnode', cn: '联邦节点选择' },
  ...
  'model.add.form.internal.placeholder': { en: 'Select Public Model', cn: '选择公共模型' },
  ...
  'model.add.loading': { en: 'The model is loading', cn: '模型正在加载中' },
