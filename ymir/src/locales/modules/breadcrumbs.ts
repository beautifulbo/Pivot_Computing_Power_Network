const breadcrumbs = {
  ...
  'breadcrumbs.task.trainresult': { cn: '训练结果', en: 'Train Result' },
  'breadcrumbs.task.FLtraining': { cn: '联邦训练', en: 'Model FLTraining' },
  ...
  'breadcrumbs.prediction.assets': { cn: '数据列表', en: 'Assets List' },
  ...
  'breadcrumbs.predictions': { cn: '推理结果', en: 'Predictions' },
