const project = {
  ...
  'project.tab.project.title': { en: 'project', cn: '项目名称' },
  'project.tab.model.title': { en: 'Models', cn: '模型' },
  'project.tab.createtime.title': { en: 'Create-time', cn: '创建时间' },
  ...
  'project.add.form.FL': {
    en: 'The setting of nodes in Federated learning',
    cn: '联邦学习节点数量',
  },
  'project.add.form.FL.choose': {
    en: 'Choose the method of FL',
    cn: '联邦学习方式',
  },
  'project.add.form.FL.required': {
    en: 'Please input the number of nodes in Federated Learning',
    cn: '联邦学习结点数量为必填项',
  },
  'project.add.form.FL.placeholder': {
    en: 'Please input the number of nodes in Federated Learning',
    cn: '请输入联邦学习结点数量',
  },
  'project.add.form.FL.chooseclient.placeholder': {
    en: 'Please input the number of nodes in Federated Learning',
    cn: '请输入每轮选择的客户端数量',
  },
  'project.add.form.FL.numeric': {
    en: 'Please input the number of nodes in Federated Learning',
    cn: '只能输入数字',
  },
  'project.add.form.FL.max30':{
    en: 'The number of nodes must be at least 1 and the maximum number of nodes is 30',
    cn: '结点数至少为1, 且最多为30',
  },
  'project.add.form.FL.lim':{
    en: 'The number of nodes must be among nodes',
    cn: '每轮节点数不超过结点总数量',
  },
  'project.add.nameexisted':{
