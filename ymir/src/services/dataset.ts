...
/**
 * @description get datasetstate by project id
 * @export
 * @param {QueryParams} {
 *   pid
 * }
 */
export function getdatasetstate(pid: number) {
  return request('/datasets/datasetstate', 
  { method:'POST',
    data:{
      project_id: pid,
    }
...
export function getpublicdataset() {
  return request('/datasets/publicdataset', 
  { method:'GET'
  })
}
