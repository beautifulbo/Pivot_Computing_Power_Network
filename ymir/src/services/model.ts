...
export function getpublicModels() {
  return request.get(`/models/getpublicmodels`)
}

export function getoptinalnode(id:number) {
  return request(`/models/optinalnode`,{
    method:"POST",
    data:id
  })
}
...
export function newModel(params: ModelCreateParams ) {
  return request(`/models/importmodel`,{
    method:"POST",
    data:params
  })
}

export function updatenode(pid:number, id:number ) {
  return request(`/models/importmodel`,{
    method:"POST",
    data:{
      pid:pid,
...
export function getmodellist(pid: number, offset = 0, limit = 10) {
  return request(`/models/modellist`,{
    method:"POST",
    data:{
      pid:pid,
      offset:offset,
