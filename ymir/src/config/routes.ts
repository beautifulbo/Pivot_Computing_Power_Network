...
export const homeRoutes = [
  ...
  // },
  {
    path: '/home/project/:id/FLtrain',
    name: 'taskTrain',
    component: '@/pages/task/FLtrain/index',
    title: 'task.train.title',
    pid: 24,
    id: 5,
    breadcrumbLabel: 'breadcrumbs.task.training',
  ...
  {
    path: '/home/project/:id/trainresult',
    name: 'taskTrain',
    component: '@/pages/task/train_result/index',
    title: 'task.trainresult.title',
    pid: 24,
    id: 5,
    breadcrumbLabel: 'breadcrumbs.task.trainresult',
  },
  {
  ...
  },
  {
    ...
    redirect: '/home/project/:id/trainresult',
    // name: 'modelDetail',
  ...
  {
    path: '/home/project/:id/llmm/inference',
    name: 'llmmInference',
    component: '@/pages/llmm/inference',
    title: 'llmm.inference.title',
    pid: 24,
    id: 45,
    breadcrumbLabel: 'breadcrumbs.llmm.infer.title',
  },
]
...
const Routes = [
  ...
  },
  {
    ...
    routes: [
      ...
      {
        path: '/login',
        component: '@/pages/user/MockAutoLogin',
        title: 'login.title',
      },
    ],
  },
