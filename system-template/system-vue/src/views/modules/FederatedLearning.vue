  ...
  <div class="module-container">
    ...
    <el-card class="module-card" v-if="!showIframe">
      ...
      <div class="module-header">
        ...
        <h1 class="module-title">泛在协同计算</h1>
        <p class="module-subtitle">分布式协同计算服务平台</p>
      </div>
...
export default {
  ...
  activated() {
    console.log("✅ [FederatedLearning] activated()");
    // 组件激活时，如果之前显示了iframe，继续显示
  },
  deactivated() {
    console.log("⏸️ [FederatedLearning] deactivated()");
    // 组件失活时，不修改showIframe状态，保持iframe的显示状态
    // GlobalIframeManager会根据当前路由自动控制显示/隐藏
  },
  methods: {
    enterSystem() {
      console.log("🚀 [FederatedLearning] 进入iframe模式");
      ...
      console.log("✅ [FederatedLearning] 状态设置完成");
    },
    goBack() {
