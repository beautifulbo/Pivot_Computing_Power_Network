  ...
  <div class="module-container">
    ...
    <el-card class="module-card" v-if="!showIframe">
      ...
      <div class="module-header">
        <div class="module-icon" :style="{ background: '#909399' }">
          <i class="el-icon-box"></i>
        </div>
        <h1 class="module-title">可信生态与溯源</h1>
        <p class="module-subtitle">区块链可信生态与数据溯源平台</p>
      </div>
      ...
      <div class="module-section">
        ...
        <p class="section-content">
          维护灵活可追溯AI数据计算模型生态，基于区块链研究灵活可追溯的模型与算力交易管理机制，建立竞争均衡的双向信用评价模型。
        </p>
      </div>
      ...
      <div class="module-section">
        ...
        <ul class="features-list">
          <li>
            <el-tag type="info" effect="plain">区块链数据溯源</el-tag>
            <span>记录数据全生命周期，实现端到端可追溯</span>
          </li>
          <li>
            <el-tag type="info" effect="plain">可信身份认证</el-tag>
            <span>基于区块链的数字身份体系，保障身份可信</span>
          </li>
          <li>
            <el-tag type="info" effect="plain">智能合约管理</el-tag>
            <span>支持智能合约的编写、部署和调用，自动化业务流程</span>
          </li>
          <li>
            <el-tag type="info" effect="plain">多方协作治理</el-tag>
            <span>支持联盟链治理，实现多方安全协作</span>
          </li>
          <li>
            <el-tag type="info" effect="plain">模型确权与共享</el-tag>
            <span>明确模型权属，支持可控的模型贡献和交易</span>
          </li>
        </ul>
      </div>
...
export default {
  ...
  data() {
    return {
      externalUrl: "https://hitchily-nonemancipative-lizeth.ngrok-free.dev",
    };
  },
  computed: {
